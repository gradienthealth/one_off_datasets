...
class Siim_covid_19(tfds.core.GeneratorBasedBuilder):
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    # TODO(siim-covid-19): Specifies the tfds.core.DatasetInfo object
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    # TODO(siim-covid-19): Downloads the data and defines the splits
    # dl_manager is a tfds.download.DownloadManager that can be used to
    # download and extract URLs
    files_dir = 's3://gradient-scratch/kerry/siim-covid19-detection'
    download_dir = dl_manager.download_and_extract('https://s3.wasabisys.com/gradient-scratch/kerry/siim-covid19-detection/train.tar.gz')
    return {
